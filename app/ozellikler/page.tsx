...
const FEATURES = [
    ...
    { icon: CreditCard, color: 'bg-purple-600', glow: 'shadow-purple-200', light: 'bg-purple-50 border-purple-100', title: 'Online Kapora & Ödeme Alma', desc: 'Randevuyu alırken ödemenizi de alın. Müşterinize kredi kartıyla taksit kolaylığı sunun. Borcun peşinden koşmak tarihe karışsın.' },
    { icon: ImageIcon, color: 'bg-[#4a2260]', glow: 'shadow-purple-200', light: 'bg-purple-50 border-purple-100', title: 'Fotoğraf Seçtirme Galerisi', desc: 'Müşterileriniz kendi özel panellerinden fotoğraflarını seçsin. Favorilediklerini anında görün, dijital teslimatı tamamlayın.' },
    { icon: FileText, color: 'bg-indigo-600', glow: 'shadow-indigo-200', light: 'bg-indigo-50 border-indigo-100', title: 'Online Dijital Sözleşme', desc: "Sözleşmeyi SMS'le link olarak gönderin, müşteri ekranda imzalasın. Elden imza almak için koşturmak bitti." },
    { icon: Users, color: 'bg-violet-600', glow: 'shadow-violet-200', light: 'bg-violet-50 border-violet-100', title: 'Ekip & Olay Yönetimi', desc: "Düğün çekimindeki kuaför, kız alma, konvoy gibi olayları tanımlayın, personellerinizi etiketleyin, SMS'le bildirimi otomatik gönderilsin." },
    { icon: Globe, color: 'bg-fuchsia-600', glow: 'shadow-fuchsia-200', light: 'bg-fuchsia-50 border-fuchsia-100', title: 'Kurumsal Web Sitesi', desc: 'Markanıza özel, modern ve SEO uyumlu bir web sitesi. Albüm galeri, referans sayfası ve iletişim formuyla eksiksiz.' },
    { icon: BellRing, color: 'bg-[#5d2b72]', glow: 'shadow-purple-200', light: 'bg-purple-50 border-purple-100', title: 'Otomatik SMS Bildirimleri', desc: 'Randevu hatırlatma, ödeme tarihi uyarısı veya teslimat bilgisi — kurumsal SMS şablonlarınızı siz belirleyin, sistem otomatik göndersin.' },
    { icon: BarChart2, color: 'bg-purple-500', glow: 'shadow-purple-200', light: 'bg-purple-50 border-purple-100', title: 'Gelir & Alacak Takibi', desc: 'Aylık gelir, bekleyen ödemeler ve alacaklarınızı tek ekranda görün. Ödeme gününden önce sistem müşteriye hatırlatma göndersin.' },
    { icon: Smartphone, color: 'bg-indigo-500', glow: 'shadow-indigo-200', light: 'bg-indigo-50 border-indigo-100', title: 'Mobil Uygulamadan Yönetim', desc: 'Dışarıdayken bile tüm sisteminizi cebinizden yönetin. iOS ve Android uyumlu uygulama ile her şey yanınızda.' },
];
