    ...
    return (
        <div className="p-8">
            <div className="max-w-6xl mx-auto">
                <h1 className="text-3xl font-bold text-gray-800 mb-6">Paketler Ayarları</h1>

                <div className="bg-white rounded-lg shadow-md p-6">
                    <p className="text-gray-600 mb-4">
                        Web sitenizde görüntülenecek paketleri buradan düzenleyebilirsiniz.
                    </p>

                    {/* Paketler ayarları form ve içerikleri buraya eklenecek */}
                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                        <p className="text-gray-500">Paketler düzenleme araçları yakında eklenecek...</p>
                    </div>
                </div>
            </div>
        </div>
